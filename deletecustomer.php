					...
					<div class="banner_content">
						<div class="media">
							...
							<div class="media-body">
                                ...
                                <?php echo "<form method='post' action='deleting.php'>"?>
								<h1 align=center font-family=georgia>Enter the name of the Customer that you want to delete </h1><br>
									<table align="center" border="0px" style="background-image:url('color.png');">
