					...
					<div class="banner_content">
						<div class="media">
							...
							<div class="media-body">
                                ...
                                <?php echo "<form method='post' action='adding.php'>"?><br><br>
								<h1 align=center font-family=georgia>Add customer details</h1>
									<table border="0px" style="background-image:url('color.png');">
									<tr><td>Name:</td><td><input type="text" name="name" required></td></tr>
                                    <tr><td>Email:</td><td><input type="email" name="email"  required></td></tr>
                                    <tr><td>Account No.</td><td><input type="number" name="acc"  required></td></tr>
                                    <tr><td>Balance:</td><td><input type="number" name="balance"required></td></tr>
                                    <tr><td>Location:</td><td><input type="text" name="location" required></td></tr>

									<tr><td></td><td><input class="btn btn-primary" type="submit" name="submit" value="Submit" align=center style="margin-top:6px; margin-bottom:6px;margin-left:6px; width:8em; height=2em; font-size=15px;  font-weight:bold;"></td></tr>
									</table>
									</form>
								</div>
							</div>
